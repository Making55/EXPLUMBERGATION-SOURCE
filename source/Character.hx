	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?isDebug:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'signDeath':
				...
				addOffset('firstDeath', -100, 480);
				addOffset('deathLoop', -370, -480);
				addOffset('deathConfirm', 630, 470);
			...
			case 'exTricky':
				...
				addOffset('idle');
				addOffset("Hank", 0, 210);
				addOffset("singUP", -150, 290);
				addOffset("singRIGHT", -50, 100);
				addOffset("singLEFT", 127, 20);
				addOffset("singDOWN", -70, 150);
