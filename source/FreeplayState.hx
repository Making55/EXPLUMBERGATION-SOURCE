...
class FreeplayState extends MusicBeatState
{
	...
	override function create() {
		...
		songFour = new TrickyButton(300,420,'menu/freeplay/Explumbergation Button','menu/freeplay/Explumbergation Confirm',selectSong, 'explumbergation', 0, 15);

		songFour.spriteOne = new FlxSprite(songFour.trueX + songFour.tweenX, songFour.trueY + songFour.tweenY).loadGraphic(Paths.image('menu/freeplay/Explumbergation Button',"clown"), true, 800, 200);
        songFour.spriteTwo = new FlxSprite(songFour.trueX + songFour.tweenX, songFour.trueY + songFour.tweenY).loadGraphic(Paths.image('menu/freeplay/Explumbergation Confirm',"clown"), true, 800, 200);
		...
		{
			var locked:FlxSprite = new FlxSprite(songFour.trueX, songFour.trueY).loadGraphic(Paths.image('menu/freeplay/Explumbergation Locked','clown'), true, 900, 200);
	...
	function diffGet()
	{
		if (songs[selectedIndex].pognt == 'explumbergation')
		{
		switch (diff)
		{
			case 0:
	...
	override function update(elapsed:Float)
	{
		...
		if (MusicMenu.Vocals != null)
		{
			...
			var score = Highscore.getScore(songs[selectedIndex].pognt,diff);
			if (songs[selectedIndex].pognt == 'explumbergation')
				score = Highscore.getScore(songs[selectedIndex].pognt,diff);
