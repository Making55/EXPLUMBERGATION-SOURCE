...
class PlayState extends MusicBeatState
{
	...
	public var ExTrickyLinesSing:Array<String> = ["YOU AREN'T LUIGI", "WHERE IS PEACH", "BOWSER???", "WHO ARE YOU", "WHERE AM I", "WAHOOOOOO", "IT'S ME MARIO", "SUPER MARIO", "WHY CAN'T I BLJ?????"];
	...
	override public function create()
	{
		...
		var hole:FlxSprite = new FlxSprite(-65,530).loadGraphic(Paths.image('fourth/Spawnhole_Ground_BACK','clown'));
		var converHole:FlxSprite = new FlxSprite(-36,578).loadGraphic(Paths.image('fourth/Spawnhole_Ground_COVER','clown'));
		...
		else if (SONG.song.toLowerCase() == 'explumbergation')
		{
			//trace("line 538");
			defaultCamZoom = 0.55;
			...
			weegee = new FlxSprite(1200,-170);
			weegee.frames = Paths.getSparrowAtlas('fourth/WEEGEE','clown');
			weegee.animation.addByPrefix('dance','WEEGEE',24);
			weegee.animation.play('dance');
			weegee.scrollFactor.set(0.9, 0.9);
			weegee.setGraphicSize(Std.int(weegee.width * 0.8));
		...
		if (curSong.toLowerCase() == 'explumbergation')
	{
		...
		new FlxTimer().start(28, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(33, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(37, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(41, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(42, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(46, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(49, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(54, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(56, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(57, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(59, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(61, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(63, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(64, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(67, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(68, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(70, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(71, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(72, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(73, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(74, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(76, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(78, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(79, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(80, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(81, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(82, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(83, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(84, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(86, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(88, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(89, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(90, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(91, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(92, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(93, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(94, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(95, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(96, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(97, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(98, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(99, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(101, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(102, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(103, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(104, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(105, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(106, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(151, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(152, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(153, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(154, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(155, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(156, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(157, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(158, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(159, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(160, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(161, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(162, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(163, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(164, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(165, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(166, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(167, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(168, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
		...
		new FlxTimer().start(169, function(tmr:FlxTimer)
		{	
			if (this.health > 0.05)
			{
			this.health -= 0.04;
	...
	function doClone(side:Int)
	{
		switch(side)
		{
			...
			case 1:
				if (cloneTwo.alpha == 1)
					return;
				cloneTwo.x = dad.x + 485;
				cloneTwo.y = dad.y + 500;
				cloneTwo.alpha = 1;
	...
	function startCountdown():Void
	{
		...
		if (SONG.song.toLowerCase() == 'explumbergation') // start the grem time
		{
			new FlxTimer().start(25, function(tmr:FlxTimer) {
				if (curStep < 2400)
				{
			...
			if (generatedMusic)
				{
					notes.forEachAlive(function(daNote:Note)
					{
						...
						if (!daNote.mustPress && daNote.wasGoodHit)
						{
							...
							if (!(curBeat >= 532 && curBeat <= 536  && curSong.toLowerCase() == "explumbergation")){
	...
	public function endSong():Void
	{
		...
		{
			if (song.toLowerCase() == "explumbergation")
	...
	override function beatHit()
	{
		...
		if (curBeat == 532 && curSong.toLowerCase() == "explumbergation")
		{
			dad.playAnim('Hank', true);
		}

		if (curBeat == 536 && curSong.toLowerCase() == "explumbergation")
		{
